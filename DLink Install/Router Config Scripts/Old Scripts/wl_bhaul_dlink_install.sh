 You Telecom Install Script - Flipside 2018

# chmod +x wl_bhaul_dlink_install.sh
...
echo "   * Port '1': WIRELESS backhaul" >> /etc/banner
...
echo "        option ports '0t 1 2 3'" >> /etc/config/network
echo "" >> /etc/config/network
echo "config switch_vlan" >> /etc/config/network
echo "        option device 'switch0'" >> /etc/config/network
...
echo "        option ports '0t 4'" >> /etc/config/network
#****************************************************************************
#System Configs
