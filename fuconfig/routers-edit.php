   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-body">
        ...
        <div class="row mt-2">
  				...
  				<div class="col-6"><input type="text" id="number" name="number" class="form-control" value="<?=$router->number?>" /></div>
  			</div>
        ...
        <div class="row mt-2">
  				...
  				<div class="col-6"><input type="text" id="enclosed" name="enclosed" class="form-control" value="<?=$router->enclosed?>" /></div>
  			</div>

        <div class="row mt-2">
  				<div class="col-3"><strong>Notes: </strong></div>
  				<div class="col-6"><input type="text" id="notes" name="notes" class="form-control" value="<?=$router->notes?>" /></div>
  			</div>

      </div>

      <div class="modal-footer">
  			<button id="btnSubmitRouterForm" class="btn btn-primary"><?=$currentRequest->IsUpdateRequest() ? 'Edit' : 'Add' ?></button>
