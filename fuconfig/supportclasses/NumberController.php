...
class NumberController extends Controller {
	...
	public function Setup($phone_id = null, $callerid = null, $number = null, $directory_id = null,
								$number_type_id = null, $isnew = false, $number_id = null, $assignment_id = null,
								$password_index = 1) {
...
*/
	...
	public function SetupFromPageRequest($pageRequest) {
		...
		$this->Setup($pageRequest->phone_id, $pageRequest->callerid, $pageRequest->number, $pageRequest->directory_id,
							$pageRequest->number_type_id, $pageRequest->isnew, $pageRequest->number_id,
							$pageRequest->phone_number_assignment_id, $pageRequest->password_index);
