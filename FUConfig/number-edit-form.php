...
<div class="modal-dialog modal-dialog-centered" role="document">
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="row">
				<div class="col alert alert-warning m-2"><strong>Warning: </strong>Multiple phones (<?=$numberCount?>) have this number. All will be edited simultaneously.</div>
			</div>
			<?php } ?>

			<div class="row mt-2">
				<div class="col-3"><strong>Display Order: </strong></div>
				<div class="col-6"><input type="text" id="display_order" name="display_order" class="form-control" value="<?=$assignment->display_order ?>" /></div>
			</div>

			<div class="row mt-2">
				<div class="col-3"><strong>Caller ID: </strong></div>
				<div class="col-6"><input type="text" id="callerid" name="callerid" class="form-control" value="<?=$number->callerid ?>" /></div>
			</div>

			<div class="row mt-2">
				<div class="col-3"><strong>Number: </strong></div>
				<div class="col-6"><input type="text" id="number" name="number" class="form-control" value="<?=$number->number?>" /></div>
			</div>
			...
			<div class="row mt-2">
				...
				<div class="col-6">
					<select class="form-control" id="password_index" name="password_index">
						<option value="1" <?php if ($number->password_index == 1)  { ?> selected="selected" <?php } ?>>User/Pass 1</option>
						<option value="2" <?php if ($number->password_index == 2)  { ?> selected="selected" <?php } ?>>User/Pass 2</option>
					</select>
				</div>
			</div>
		...
		<div class="modal-footer">
			<button id="btnSubmitNumberAddEditForm" class="btn btn-primary"><?=$currentRequest->IsUpdateRequest() ? 'Edit' : 'Add' ?></button>
