...
class PhoneNumberAssignment extends DataClass {
	...
	protected function Setup() {
		...
		//All table fields
		$this->tableFields = array("phone_number_assignment_id" => null, "number_id" => null,
			"phone_id" => null, "number_type_id" => null, "buttonconfig_id" => null,
			"todelete_assignment" => 0, "added_assignment" => 1, "password_index" => 1, "display_order" => 1);
