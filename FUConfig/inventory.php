...
<div class="container-fluid">
	<div class="row">
		<div class="col"><h1 class="display-4">Inventory</h1></div>
		<div class="col-sm align-self-center justify-content-end"><a class="btn btn-primary" href="<?=$addRequest->GetRequestAction()?>" role="button">Add New Phone</a></div>
	</div>
	<div class="row">
		<div class="col-sm">
			...
			<table class="table">
				...
				<?php
					...
					{ 
						...
						$updateAvailableForm = new FormRequest("update_available_form", 
												PageRequest::UPDATE, "inventory-update.php", FormRequest::POST);
					...
					<tr>
						...
						<td>
							<?=$updateAvailableForm->OutputDataClassAsHiddenForm($updateAvailableData, 
