				...
				<div class="col-6">
					<select class="form-control" id="number_type_id" name="number_type_id" onClick="updateExistingNumberList()">
						<?php
							...
							{ 
						?>
							<option <?=$row['number_type_id'] == 2 ? 'selected="selected"' : '';?> 
								value="<?=$row['number_type_id'];?>"> 
			...
			<div class="row mt-2">
				...
				<div class="col-6">
					<div class="form-check">
						<input type="radio" class="form-check-input" id="sortby1" name="sortby" value="number" checked><label class="form-check-label" for="sortby1">Number</label>
					</div>
					<div class="form-check">
						<input type="radio" class="form-check-input" id="sortby2" name="sortby" value="callerid" /><label class="form-check-label" for="sortby1">Caller ID</label>
					</div>
				</div>
			</div>
