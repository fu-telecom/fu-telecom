...
<div class="container-fluid">
	...
	<form method="post" action="<?=$formSubmitRequest->GetRequestAction()?>">
		...
		<div class="row m-2 ml-4">
			...
			<div class="col-3"><input class="form-control" type="text" id="name" name="org_name" value="<?=$org->org_name?>" /></div>
		</div>
		
		<div class="row m-2 ml-4">
			<div class="col-2"><strong>Contact Name: </strong></div>
			<div class="col-3"><input class="form-control" type="text" id="contactname" name="org_contactname" value="<?=$org->org_contactname?>" /></div>
		</div>
		
		<div class="row m-2 ml-4">
			<div class="col-2"><strong>Contact Phone: </strong></div>
			<div class="col-3"><input class="form-control" type="text" id="contactphone" name="org_contactphone" value="<?=$org->org_contactphone?>" /></div>
		</div>
		
		<div class="row m-2 ml-4">
			<div class="col-2"><strong>Contact Email: </strong></div>
			<div class="col-3"><input class="form-control" type="text" id="contactemail" name="org_contactemail" value="<?=$org->org_contactemail?>" /></div>
		</div>
