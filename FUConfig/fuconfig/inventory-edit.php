...
<div class="container">
	...
	<div class="row mt-4">
		...
		<div class="col">
			...
			<input type="hidden" value="<?= $inventoryPhone->phone_inventory_id ?>"
				id="phone_inventory_id" name="phone_inventory_id" />
		</div>
	</div>
	<?php } ?>
	<div class="row mt-2">
		...
		<div class="col-3">
			<select class="form-control" id="phone_inventory_model_id" name="phone_inventory_model_id">
				<?php
					...
					{
				?>
					<option <?=$phoneModel->phone_model_id == $inventoryPhone->phone_inventory_model_id ? 'selected="selected"' : '';?>
						value="<?=$phoneModel->phone_model_id;?>">
	...
	<div class="row mt-2">
		...
		<div class="col-3">
			<input type="text" class="form-control" value="<?=$inventoryPhone->sip_username1?>"
				id="sip_username1" name="sip_username1" />
		</div>
	</div>
	...
	<div class="row mt-2">
		...
		<div class="col-3">
			<input type="text" class="form-control" value="<?=$inventoryPhone->sip_password1?>"
				id="sip_password1" name="sip_password1" />
		</div>
	</div>
	...
	<div class="row mt-2">
		...
		<div class="col-3">
			<input type="text" class="form-control" value="<?=$inventoryPhone->sip_username2?>"
				id="sip_username2" name="sip_username2" />
		</div>
	</div>
	...
	<div class="row mt-2">
		...
		<div class="col-3">
			<input type="text" class="form-control" value="<?=$inventoryPhone->sip_password2?>"
				id="sip_password2" name="sip_password2" />
		</div>
	</div>

	<div class="row mt-5">
		<div class="col">
			<input type="hidden" id="phone_inventory_available" name="phone_inventory_available" value="<?=$inventoryPhone->phone_inventory_available?>" />
